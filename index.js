...
function get20s(arr) {
  ...
  for (let i = 0; i < arr.length; i++) {
    const yearBorn = Number(arr[i].years.split(" ")[0]);
    const yearDied = Number(arr[i].years.split(" ")[2]);
...
function addArtist(arr) {
  arr.push({
    ...
    bio: "Lorem ipsum dolor sit amet consectetur adipisicing elit. Reiciendis unde dolores vero aut corrupti officia autem ea dolore porro neque.",
  });
  return arr;
}
